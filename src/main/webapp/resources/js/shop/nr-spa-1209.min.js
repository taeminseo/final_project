! function(t, n, e) {
    ...
    2: [function(t, n, e) {
        ...
        function i(t, n) {
            return n || (n = {
                count: 0
            }), n.count += 1, p(t, function(t, e) {
                n[t] = o(e, n[t])
            }), n
        }

        function o(t, n) {
            return n ? (n.c || (n = u(n.t)), n.c += 1, n.t += t, n.sos += t * t, t > n.max && (n.max = t), t < n.min && (n.min = t), n) : {
                t: t
            }
        }
        ...
        function s(t, n) {
            return n ? (n.c || (n = u(n.t)), n.min = Math.min(t.min, n.min), n.max = Math.max(t.max, n.max), n.t += t.t, n.sos += t.sos, n.c += t.c, n) : t
        }
        ...
        function f(t, n) {
            return n ? m[t] && m[t][n] : m[t]
        }

        function d(t) {
            for (var n = {}, e = "", r = !1, i = 0; i < t.length; i++) e = t[i], n[e] = h(m[e]), n[e].length && (r = !0), delete m[e];
            return r ? n : null
        }

        function h(t) {
            return "object" != typeof t ? [] : p(t, l)
        }
    ...
    3: [function(t, n, e) {
        ...
        function a(t, n, e, r, i, o, a) {
            if (n = window.encodeURIComponent(n), y += 1, m.info.beacon) {
                var s = x + "://" + m.info.beacon + "/1/" + m.info.licenseKey;
                s += "?a=" + m.info.applicationID + "&", s += "t=" + n + "&", s += "qt=" + ~~e + "&", s += "ap=" + ~~r + "&", s += "be=" + ~~i + "&", s += "dc=" + ~~o + "&", s += "fe=" + ~~a + "&", s += "c=" + y, l.img(s)
            }
        }
        ...
        function u(t, n, e) {
            ++w > 10 || (m.releaseIds[n.slice(-200)] = ("" + e).slice(-200))
        }
        var c = t(17),
            f = t(10),
            d = t(2),
            ...
            g = t(39),
            y = 0,
            x = g.getConfiguration("ssl") === !1 ? "http" : "https";
    ...
    10: [function(t, n, e) {
            ...
            if (t.info.beacon) {
                ...
                if (e) {
                    ...
                    if (i.push(e), i.push(x.param("tt", t.info.ttGuid)), i.push(x.param("us", t.info.user)), i.push(x.param("ac", t.info.account)), i.push(x.param("pr", t.info.product)), i.push(x.param("af", g(t.features, function(t) {
                        ...
                        i.push(x.param("perf", b(o)))
                    }
                    if (window.performance && window.performance.getEntriesByType) {
                        var a = window.performance.getEntriesByType("paint");
                        a && a.length > 0 && a.forEach(function(t) {
                            !t.startTime || t.startTime <= 0 || ("first-paint" === t.name ? i.push(x.param("fp", String(Math.floor(t.startTime)))) : "first-contentful-paint" === t.name && i.push(x.param("fcp", String(Math.floor(t.startTime)))), H(t.name, Math.floor(t.startTime)))
                        })
                    }
                    ...
                    w.jsonp(U + "://" + t.info.beacon + "/" + r + "/" + t.info.licenseKey + u, R)
                }
            }
        }

        function i(t) {
            var n = g(A, function(n) {
                return s(n, t, {
                    unload: !0
                })
            });
        ...
        function c(t, n, e, r, i, o) {
            ...
            if (!(e.body || "jserrors" === t && e.qs && e.qs.cm)) return o && o({
                sent: !1
            }), !1;
            r || (r = {});
            ...
            var s, u = i.method,
                c = i.useBody,
                d = a;
            c && "events" === t ? s = e.body.e : c ? s = b(e.body) : d = a + x.obj(e.body, n.maxBytes);
            var h = u(d, s);
            if (o && u === w.xhr) {
                var l = h;
                l.addEventListener("load", function() {
                    ...
                    429 === this.status ? (t.retry = !0, t.delay = L) : 408 !== this.status && 500 !== this.status && 503 !== this.status || (t.retry = !0), r.needResponse && (t.responseText = this.responseText), o(t)
                }, !1)
            }
            return h || u !== w.beacon || (u = w.img, h = u(a + x.obj(e.body, n.maxBytes))), h
        }
        ...
        function f(t, n) {
            ...
            if (n.needResponse) {
                if (!_) return !1;
                r = !0, e = w.xhr
            } else if (n.unload) r = F, e = F ? w.beacon : w.img;
            else if (_) r = !0, e = w.xhr;
            else {
        ...
        function p(t) {
            var n = !0;
            return "init" in NREUM && "privacy" in NREUM.init && (n = NREUM.init.privacy.cookies_enabled), ["?a=" + t.info.applicationID, x.param("sa", t.info.sa ? "" + t.info.sa : ""), x.param("v", N), d(t), x.param("ct", t.customTransaction), "&rst=" + t.now(), "&ck=" + (n ? "1" : "0"), x.param("ref", C(S.getLocation()))].join("")
        }
        ...
        var v = t(19),
            ...
            L = E.getConfiguration("harvest.tooManyRequestsDelay") || 60,
    ...
    24: [function(t, n, e) {
        function r(t, n) {
            if (v(n)) {
                ...
                var e = n.maxLCPTimeSeconds || 60,
                    r = n.initialHarvestSeconds || 10;
                M = n.harvestTimeSeconds || 30;
                var u = new S(j, "events", {
                    onFinished: d,
                    getPayload: p
                });
                E("timing", f), E("lcp", o), E("cls", a), E("pageHide", s), C(h), setTimeout(function() {
                    i(), A = !0
                }, 1e3 * e), u.startTimer(M, r)
            }
        }
        ...
        function i() {
            if (!A && null !== F) {
                ...
                n && (e.cls = n), c("lcp", Math.floor(t.startTime), e, !1), A = !0
            }
        }
        ...
        function m(t) {
            for (var n = x(), e = "bel.6;", r = 0; r < t.length; r++) {
                var i = t[r];
                e += "e,", e += n(i.name) + ",", e += g(i.value, y, !1) + ",", l(i);
                var o = b(i.attrs, n);
    ...
    27: [function(t, n, e) {
        ...
        function a(t) {
            var n = t.match(x);
            return n || (n = t.match(y)), n ? {
                url: n[2],
                func: "Anonymous function" !== n[1] && "global code" !== n[1] && n[1] || null,
                line: +n[3],
                column: n[4] ? +n[4] : null
            } : t.match(b) || t.match(w) || "anonymous" === t ? {
                func: "evaluated code"
            } : void 0
        }
        ...
        function d(t) {
            ...
            for (var n, e = t.stacktrace, r = / line (\d+), column (\d+) in (?:<anonymous function: ([^>]+)>|([^\)]+))\(.*\) in (.*):\s*$/i, i = e.split("\n"), o = [], a = [], s = !1, u = 0, d = i.length; u < d; u += 2)
                if (n = r.exec(i[u])) {
                    ...
                    f(h.func) ? s = !0 : a.push(i[u]), s || o.push(h)
                } else a.push(i[u]);
            return o.length ? {
                mode: "stacktrace",
                name: t.name || c(t),
        ...
        function h(t) {
            ...
            var e, r, i, o = /^\s*Line (\d+) of linked script ((?:file|http|https)\S+)(?:: in function (\S+))?\s*$/i,
                ...
                l = [],
                v = !1;
            for (r in h) m.call(h, r) && !h[r].src && l.push(h[r]);
    ...
    29: [function(t, n, e) {
        function r(t) {
            ...
            var e = {
                ...
                r = k(g.releaseIds);
            return "{}" !== r && (e.qs.ri = r), n && n.err && n.err.length && !F && (e.qs.pve = "1", F = !0), e
        }
        ...
        function f(t, n, e, r) {
            ...
            if (n = n || g.now(), e || !g.onerror || !g.onerror(t)) {
                ...
                a.message && (f.message = "" + a.message), x[f.stackHash] ? f.browser_stack_hash = v(a.stackString) : (x[f.stackHash] = !0, f.stack_trace = R(a.stackString)), f.releaseIds = k(g.releaseIds);
                var d = o(f);
                ...
                if (S("errorAgg", [l, d, f, p]), null != f._interactionId) A[f._interactionId] = A[f._interactionId] || [], A[f._interactionId].push([l, d, f, p, w, r]);
                else {
                    var y = {},
        ...
        if (t(20), g.features.err) {
            var F = !1,
                L = N.getConfiguration("jserrors.harvestTimeSeconds") || 60;
    ...
    32: [function(t, n, e) {
        function r(t, n, e, r, i) {
            this.id = ++h, this.eventName = t, this.nodes = 0, this[d] = 0, this.finishTimer = null, this.checkingFinish = !1, this.lastCb = this.lastFinish = n, this.handlers = [], this.onFinished = i;
    ...
    34: [function(t, n, e) {
        ...
        function i() {
            this.resolved || (this.resolved = !0, this[$] = it)
        }
        ...
        function a(t) {
            ut || t || !st || (t = st.root), it && it[D].checkFinish(tt, nt), ot = it, it = t && !t[D].root.end ? t : null
        }
        ...
        function u(t) {
            ...
            var n = g.serializeMultiple(ht, 0, A);
        ...
        function d(t) {
            return t.ignored || !t.save && !t.routeChange ? void x.emit("interactionDiscarded", [t]) : (t.root.attrs.id = L.generateUuid(), "initialPageLoad" === t.root.attrs.trigger && (t.root.attrs.firstPaint = U["first-paint"], t.root.attrs.firstContentfulPaint = U["first-contentful-paint"]), x.emit("interactionSaved", [t]), ht.push(t), void pt.scheduleHarvest(0))
        }

        function h() {
            var t = _.getConfiguration("spa");
            return !t || t.enabled !== !1
        }
        var l = t(17),
            p = t(38),
            ...
            M = t(32),
            _ = t(39),
            H = ["click", "submit", "keypress", "keydown", "keyup", "change"],
            q = 999,
            I = "fn-start",
            P = "fn-end",
            B = "cb-start",
        ...
        n.exports = function() {
            return it && it.id
        }, x.on("feat-spa", function() {
            function t() {
                ft++, this.prevNode = it, this.ct = ct, ct = 0, rt = q
            }
            ...
            function n() {
                ...
                var t = this.jsTime || 0,
                    n = t - ct;
                ct = this.ct + t, it && (it.callback(n, this[P]), this.isTraced && (it.attrs.tracedTime = n)), this.jsTime = it ? 0 : n, a(this.prevNode), this.prevNode = null, rt = q
            }
            ...
            function e(t, n, e) {
                ...
                if (r) {
                    var i = r[D],
                        o = this.inc;
                    this.isTraced = !0, o ? i[z]-- : r && r.finish(t), e ? a(r) : i.checkFinish(tt, nt)
                }
            }

            function u(t) {
                return it && it[D] === t ? it : t.root
            }
            if (h()) {
                st = new M("initialPageLoad", 0, tt, nt, s), st.save = !0, it = st.root, st[z]++, l.on(x, I, t), l.on(w, B, t);
                var c = {
                    getCurrentNode: o,
                    setCurrentNode: a
                };
                l("spa-register", function(t) {
                ...
                }), l.on(x, P, n), l.on(w, "cb-end", n), l.on(j, I, function(t, n) {
                    var e = t[0],
                        r = e.type,
                        i = e.__nrNode;
                    if (ut || "load" !== r || n !== window || (ut = !0, this.prevNode = it = null, st && (i = st.root, st[z]--, Y(function() {
                            H.push("popstate")
                        }))), i) a(i);
                    else if ("hashchange" === r) a(at), at = null;
                    else if (n instanceof XMLHttpRequest) a(x.context(n).spaNode);
                    else if (!it && H.indexOf(r) !== -1) {
                        var o = new M(r, this[I], tt, nt, s);
                        if (a(o.root), "click" === r) {
                            var u = f(e.target);
                    ...
                    e.__nrNode = it
                }), l.on(k, "setTimeout-end", function(t, n, e) {
                    !it || rt - this.timerDuration < 0 || (!t || t[0] instanceof Function) && (it[D][z]++, this.timerId = e, et[e] = it, this.timerBudget = rt - 50)
                }), l.on(k, "clearTimeout-start", function(t) {
                    var n = t[0],
                        e = et[n];
                    if (e) {
                        var r = e[D];
                        r[z]--, r.checkFinish(tt, nt), delete et[n]
                    }
                }), l.on(k, I, function() {
                    rt = this.timerBudget || q;
                    var t = this.timerId,
                        n = et[t];
                    a(n), delete et[t], n && n[D][z]--
                }), l.on(C, I, function() {
                    a(this[$])
                }), l.on(C, "new-xhr", function() {
                    it && (this[$] = it.child("ajax", null, null, !0))
                }), l.on(C, "send-xhr-start", function() {
                    var t = this[$];
                    t && !this.sent && (this.sent = !0, t.dt = this.dt, t.jsEnd = t.start = this["send-xhr-start"], t[D][z]++)
                }), l.on(x, "xhr-resolved", function() {
                    var t = this[$];
                    if (t) {
                        var n = t.attrs;
                        n.params = this.params, n.metrics = this.metrics, t.finish(this["xhr-resolved"])
                    }
                }), l.on(E, "new-jsonp", function(t) {
                    if (it) {
                        var n = this[X] = it.child("ajax", this[V]);
                        n.start = this["new-jsonp"], this.url = t, this.status = null
                    }
                }), l.on(E, "cb-start", function(t) {
                    var n = this[X];
                    n && (a(n), this.status = 200)
                }), l.on(E, "jsonp-error", function() {
                    var t = this[X];
                    t && (a(t), this.status = 0)
                }), l.on(E, J, function() {
                    var t = this[X];
                    if (t) {
                        if (null === this.status) return t[D][z]--, void(t.cancelled = !0);
                        var n = t.attrs,
                            e = n.params = {},
                            r = p(this.url);
                ...
                }), l.on(S, V, function(t, n) {
                    it && t && (this[$] = it.child("ajax", this[V]), t.length >= 1 && (this.target = t[0]), t.length >= 2 && (this.opts = t[1]), n && this[$] && (this[$].dt = n))
                }), l.on(S, G + "start", function(t) {
                    it && (this[$] = it, it[D][z]++)
                }), l.on(S, G + "end", function(t, n, e) {
                    var r = this[$];
                    r && r[D][z]--
                }), l.on(S, W, function(t, n) {
                    var e = this[$],
                        r = this.target,
                        i = this.opts || {};
                    if (e) {
                        if (t) return e.cancelled = !0, void e[D][z]--;
                        var o, a;
                        "string" == typeof r ? o = r : "object" == typeof r && r instanceof Q ? o = r.url : window.URL && "object" == typeof r && r instanceof URL && (o = r.href), a = ("" + (r && r instanceof Q && r.method || i.method || "GET")).toUpperCase();
                        var s = e.attrs,
                            u = s.params = {},
                            c = p(o);
                        u.method = a, u.pathname = c.pathname, u.host = c.hostname + ":" + c.port, u.status = n.status, s.metrics = {
                            txSize: F(i.body) || 0,
                            rxSize: this.rxSize
                        }, s.isFetch = !0, e.finish(this[W])
                    }
                }), l.on(T, "newURL", function(t, n) {
                    it && (tt !== t && (it[D].routeChange = !0), n && (at = it)), tt = t
                }), E.on("dom-start", function(t) {
                    function n() {
                        o[z]--, o.checkFinish(tt, nt)
                    }
                    ...
                    if (it) {
                        var r = t[0],
                            ...
                            o = it.interaction;
                        i && (o[z]++, r.addEventListener("load", n, !1), r.addEventListener("error", e, !1))
                    }
                }), l.on(b, I, function() {
                    a(ot)
                }), l.on(w, "resolve-start", i), l.on(w, "executor-err", i), l.on(w, "propagate", r), l.on(w, B, function() {
                    var t = this.getCtx ? this.getCtx() : this;
                    a(t[$])
                }), l(O + "get", function(t) {
                    var n = this.ixn = it ? it[D] : new M("api", t, tt, nt, s);
                    it || (n.checkFinish(tt, nt), ft && a(n.root))
                }), l(O + "actionText", function(t, n) {
                    var e = this.ixn.root.attrs.custom;
                    n && (e.actionText = n)
                }), l(O + "setName", function(t, n, e) {
                    var r = this.ixn.root.attrs;
                    n && (r.customName = n), e && (r.trigger = e)
                }), l(O + "setAttribute", function(t, n, e) {
                    ...
                    this.ixn.save = !0
                }), l(O + "tracer", function(t, n, e) {
                    var r = this.ixn,
                        i = u(r),
                        o = x.context(e);
                    return n ? void(o[$] = i.child("customTracer", t, n)) : (o.inc = ++r[z], o[$] = i)
                }), l.on(N, I, e), l.on(N, "no-" + I, e), l(O + "getContext", function(t, n) {
                    var e = this.ixn.root.attrs.store;
                    setTimeout(function() {
                        n(e)
                    }, 0)
                }), l(O + "onEnd", function(t, n) {
        ...
        var dt = _.getConfiguration("spa.harvestTimeSeconds") || 10,
            ht = [],
            lt = [],
            pt = new v(y, "events", {
                onFinished: c,
        ...
        m.on("events", u), x.on("errorAgg", function(t, n, e, r) {
    ...
    35: [function(t, n, e) {
        ...
        function o(t, n, e, r, i) {
            function o(t, v) {
                ...
                var A = [f(x), f(t.end - t.start), f(t.jsEnd - t.end), f(t.jsTime)];
                switch (y) {
                    case 1:
                        A[2] = f(t.jsEnd - d), A.push(i(S.trigger), i(a(S.initialPageURL, m)), i(a(S.oldURL, m)), i(a(S.newURL, m)), i(S.customName), l ? "" : r ? 1 : 2, c(l && N, f, !0) + c(l && R, f, !0) + c(S.oldRoute, i, !0) + c(S.newRoute, i, !0) + i(S.id), i(t.id), c(S.firstPaint, f, !0) + c(S.firstContentfulPaint, f, !1));
                        var F = h(S.custom, i);
                        k = k.concat(F), w = F.length, T && (b++, k.push("a," + i(T)));
                        break;
                    case 2:
                    ...
                    case 4:
                        var L = S.tracedTime;
                        A.push(i(S.name), c(L, f, !0) + i(t.id))
                }
                for (var U = 0; U < t.children.length; U++) o(t.children[U], k);
                if (A.unshift(f(y), f(b += w)), v.push(A), b && v.push(k.join(";")), j) {
                    var M = ",",
                        _ = "b",
                        H = 0;
                    u(e.slice(1, 21), function(t, n) {
                        void 0 !== n ? (_ += M + f(n - H), M = ",", H = n) : (_ += M + "!", M = "")
                    }), v.push(_)
                } else 1 === y && v.push("");
                return v
            }
    ...
    36: [function(t, n, e) {
        ...
        function l(t, n) {
            if (!(_ >= I)) {
                var e = M[t];
                e || (e = M[t] = []), M[t] = n.concat(e), _ += n.length
            }
        }

        function p(t) {
            c(window.performance.getEntriesByType("resource"));
            var n = S(k(M, function(t, n) {
                return t in L ? S(k(S(n.sort(m), v(t), {}), g), y, []) : n
            }), y, []);
        ...
        function v(t) {
            ...
            return function(i, o) {
                ...
                a || (a = i[o.o] = []);
                var s = r[o.o];
                return "scrolling" !== t || x(o) ? s && o.s - s.s < e && s.e > o.s - n ? s.e = o.e : (r[o.o] = o, a.push(o)) : (r[o.o] = null, o.n = "scroll", a.push(o)), i
            }
        }
        ...
        if (T.xhrUsable && b.xhrWrappable) {
            ...
            if (n.exports = {
                ...
                P.on("feat-stn", function() {
                    function t(t) {
                        t.sent && t.responseText && !A && (A = t.responseText, e.startTimer(q)), t.sent && t.retry && H && (k(H, function(t, n) {
                            l(t, n)
                        }), H = null)
                    }

                    function n(t) {
                        if (b.now() > 9e5) return e.stopTimer(), void(M = {});
                        if (!(A && _ <= 30)) return p(t.retry)
                    }
