...
<html lang="ko" class=" borderimage"><head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="/resources/css/shop/jquery-ui-1.10.3.min.css">
    <link rel="stylesheet" type="text/css" href="/resources/css/shop/owners_new.css?v=c4fb8f4">
    <link rel="stylesheet" type="text/css" href="/resources/css/shop/cropper/cropper.css?v=c4fb8f4">
    <link href="/resources/css/shop/owners_page_base.r4caf7c6ec4f79256f0b93c98a3145f70.css" rel="stylesheet" type="text/css">
    ...
    <script src="/resources/js/shop/modernizr.min.js"></script>
    ...
    <script type="text/javascript" src="/resources/js/shop/soundmanager2.js?v=c4fb8f4"></script>
    <script type="text/javascript" src="/resources/js/shop/jquery-ui-1.10.3.min.js"></script>
    <script type="text/javascript" src="/resources/js/shop/js/google_analytics.js"></script>
        ...
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="text" id="username" name="shop_id" class="input-block-level">
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="password" id="password" name="shop_pw" class="input-block-level">
                </div>
            </div>
            <div class="controls">
            ...
            <div class="control-group center">
                <a class="register" href="/shop/register">회원가입 / 아이디 변경</a>
            </div>
...
<script type="text/javascript">
	window.NREUM||(NREUM={});
	NREUM.info={
		"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"060998d475","agent":"","transactionName":"NgQDY0YEWhICVEFQWg9OJ0JaBkAIDFkaXVoWAA9DGgpDDwZFRhdDCAQWRBoEQRULDVlWUj4IDw==","applicationID":"2104228","errorBeacon":"bam.nr-data.net","applicationTime":42
		}
		</script>
